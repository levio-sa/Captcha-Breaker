...
from skimage.filters import threshold_otsu, sobel, try_all_threshold, threshold_li, threshold_minimum, threshold_yen
...
def split_letters(image, num_letters=6, debug=False):
    ...
    # BINARY_THRESH = threshold_minimum(image)
    BINARY_THRESH = threshold_yen(image)  
